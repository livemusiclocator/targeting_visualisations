...
# Create an HTML file that will have MUCH MORE OBVIOUS highlighting
html_content = """
<!DOCTYPE html>
<html>
<head>
        ...
        function highlightLGA(selectedLGA) {
            ...
            for (let i = 0; i < lgas.length; i++) {
                if (i !== lgaIndex) {
                    ...
                    dimmedLGAs.text.push(hoverTexts[i]);
                }
            }
            
            const data = [dimmedLGAs, highlightedLGA];
...
# Write to file
with open('lga_obvious_highlighting.html', 'w') as f:
    f.write(html_content)

print("Created HTML file with OBVIOUS highlighting: lga_obvious_highlighting.html")
print("\nOpen the HTML file in a web browser and select an LGA from the dropdown to see VERY OBVIOUS highlighting!")