...
revenue_df = pd.read_csv("revpop.csv")
...
# Write to file
with open('lga_gig_density_revenue.html', 'w') as f:
    f.write(html_content)

print("Created gig density vs revenue visualization: lga_gig_density_revenue.html")
